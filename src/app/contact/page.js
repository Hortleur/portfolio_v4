...
export default function contactPage() {
    ...
    return (
        <main data-testid="contact-page" className=" md:h-[80dvh] relative w-screen pb-28 lg:pb-0 ">
            <BackButton />
            <div className="border-b-4 border-black py-4">
                <h1 className="text-center text-8xl">Contact</h1>
            </div>
            <div className="grid place-items-center md:h-full">
                <form data-testid="contact-form" action={sendMail} className="w-10/12 lg:w-2/3 py-5 px-4 flex flex-col flex-nowrap gap-10 border-8 border-black my-10">
